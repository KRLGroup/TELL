...
class BaseClassifier(torch.nn.Module):
    ...
    def __init__(self, loss: torch.nn.Module = None, name: str = "net.pth", device: torch.device = torch.device("cpu")):
        ...
        #            "Only CrossEntropyLoss, BCEWithLogitsLoss, BCELoss, MixedMultiLabelLoss or MutualInformationLoss available."
        self.loss = loss
    ...
    def fit(self, train_set: Dataset, val_set: Dataset, batch_size: int = None, epochs: int = 20, num_workers: int = 2,
